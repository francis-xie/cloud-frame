 ...
 */
package com.emis.vi.bm.common.log;
...
public class ArkLoggerFactory {
    ...
    public static final String  SOFA_ARK_LOGGER_SPACE        = "com.emis.vi.bm";

    private static final String SOFA_ARK_DEFAULT_LOGGER_NAME = "com.emis.vi.bm";
