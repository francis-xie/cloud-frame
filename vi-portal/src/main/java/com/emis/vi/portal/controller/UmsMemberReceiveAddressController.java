package com.emis.vi.portal.controller;

import com.emis.vi.common.api.CommonResult;
import com.emis.vi.model.UmsMemberReceiveAddress;
import com.emis.vi.portal.service.UmsMemberReceiveAddressService;
...
public class UmsMemberReceiveAddressController {
    ...
    @ResponseBody
    public CommonResult update(@PathVariable(value = "id") Long id, @RequestBody UmsMemberReceiveAddress address) {
    ...
    @ResponseBody
    public CommonResult<UmsMemberReceiveAddress> getItem(@PathVariable(value = "id") Long id) {
