...
public class SmsCouponController {
    ...
    @ResponseBody
    public CommonResult update(@PathVariable(value = "id") Long id,@RequestBody SmsCouponParam couponParam) {
    ...
    @ResponseBody
    public CommonResult<SmsCouponParam> getItem(@PathVariable(value = "id") Long id) {
