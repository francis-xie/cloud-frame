<%--$Id$
  ...
  service 1：订单扣款接口、2：订单查询接口、3：订单撤销接口、4：订单退款接口、5：订单退款查询接口
  http://127.0.0.1:8301/iwill/jsp/ccr/getUnionpay.jsp?service=2&orderId=XL00001XL000010120171218145834&txnTime=20171218145834
--%>
...
<%@ page import="com.emis.vi.pay.unionpay.util.SDKConfig" %>
<%@ page import="com.emis.vi.pay.unionpay.PayAction" %>
...
//    logger = emisLogger.getlog4j(application, "jsp.ccr.getUnionpay." + emisUtil.formatDateTime("%y%M", emisUtil.now()));
    logger = LogManager.getLogger("jsp.ccr.getUnionpay." + emisUtil.formatDateTime("%y%M", emisUtil.now()));
