...
<%@ page import="com.emis.vi.pay.util.emisLogger" %>
<%@ page import="com.tencent.common.Configure" %>
<%@ page import="com.tencent.protocol.refund_protocol.RefundReqData" %>
<%@ page import="com.emis.vi.pay.wxpay.BridgeForScanPayBusiness" %>
<%@ page import="com.emis.vi.pay.wxpay.WXScanPayBusiness" %>
<%@ page import="com.emis.vi.pay.wxpay.WXScanPayReqData" %>
<%@ page import="com.emis.vi.pay.wxpay.V2.WXPayV2ConfigImpl" %>
<%@ page import="java.util.HashMap" %>
<%@ page import="com.emis.vi.pay.wxpay.V2.bean.emisWXPayStoreSettingBean" %>
<%@ page import="com.emis.vi.pay.wxpay.V2.emisWXPayStoreSettingKeeper" %>
<%@ page import="com.emis.vi.pay.util.emisPropUtil" %>
<%@ page import="org.apache.log4j.LogManager" %>
<%
  /**
   * $Id: getWXpay.jsp 14847 2019-07-02 02:26:08Z harry.chen $
   * 微信付款接口
   * ex: http://localhost:8080/venus//jsp/ccr/getWXpay.jsp?JSONparam={"attach":"","authCode":"","billDate":"","billType":"","body":"","detail":"","deviceInfo":"","goodsTag":"","opUserID":"","outRefundNo":"","outTradeNo":"00200200012015111917234530225","refundFee":0,"refundFeeType":"","refundID":"","service":"3","spBillCreateIP":"","timeExpire":"","timeStart":"","totalFee":"","transactionID":"","userIp":""}
   */
  //微信支付系统参数
...
//        oLogger = emisLogger.getlog4j(application, "jsp.crr.getWXpay2." + emisUtil.formatDateTime("%y%M%D", emisUtil.now()));
        oLogger = LogManager.getLogger("jsp.ccr.getWXpay2." + emisUtil.formatDateTime("%y%M", emisUtil.now()));
...
//        WXPayV2ConfigImpl wxPayConfig = new WXPayV2ConfigImpl("wxaf8892243bcc83dd", "1445559802", "e0df56979bff5b0c15ea794f69ac11ed", "D:\\cert\\apiclient_cert.p12");
        emisWXPayStoreSettingBean WXPaySetting = emisWXPayStoreSettingKeeper.getInstance().getStoreWXPaySetting(application, sS_NO);
...
//      oLogger = emisLogger.getlog4j(application, "jsp.crr.getWXpay." + emisUtil.formatDateTime("%y%M", emisUtil.now()));
      oLogger = LogManager.getLogger("jsp.ccr.getWXpay." + emisUtil.formatDateTime("%y%M", emisUtil.now()));
