package com.emis.vi.pay.wxpay.V2.common;
...
import static com.emis.vi.pay.wxpay.V2.common.WXPayConstants.USER_AGENT;
...
public class WXPayRequest {
    ...
    private String requestOnce(final String domain, String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert) throws Exception {
        ...
        httpPost.addHeader("User-Agent", USER_AGENT + " " + config.getMchID());  // TODO: 很重要，用来检测 sdk 的使用情况，要不要加上商户信息？
