 ...
 */
public class WXPayV2DomainSimpleImpl implements IWXPayDomain {

/*
    private static class WxpayDomainHolder{
        private static IWXPayDomain holder = new com.github.wxpay.sdk.WXPayV2DomainSimpleImpl();
    }
...
*/
  ...
  public WXPayV2DomainSimpleImpl() {
  }
