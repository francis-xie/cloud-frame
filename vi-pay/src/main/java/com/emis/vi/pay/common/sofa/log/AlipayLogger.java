 ...
 */
package com.emis.vi.pay.common.sofa.log;

import com.emis.vi.pay.common.sofa.utils.AlipayLoggerFactory;
...
public class AlipayLogger {
    public static final Logger INFO_THREAD_LOGGER = AlipayLoggerFactory
            .getLogger("com.emis.vi.pay.alipay");
    public static final Logger WARN_THREAD_LOGGER = AlipayLoggerFactory
            .getLogger("com.emis.vi.pay.alipay.warn");
