...
/*$Id: HttpProtocolHandler.java 14052 2014-12-16 10:33:05Z francis.xie $ *
...
public class HttpProtocolHandler {
  ...
  public HttpResponse execute(HttpRequest request, String strParaFileName, String strFilePath) throws HttpException, IOException {
    AlipayConfig.logger.info("execute>>>Start");
    ...
    try {
      ...
      AlipayConfig.logger.info("execute>>>statusCode:" + statusCode);
      ...
      AlipayConfig.logger.error(ex.getMessage(), ex);
      return null;
      ...
      AlipayConfig.logger.info("execute>>>End");
    }
    return response;
  }
