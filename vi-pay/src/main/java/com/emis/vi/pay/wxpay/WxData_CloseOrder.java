 ...
 */
public class WxData_CloseOrder {
   ...
   */
  @Deprecated
  public WxData_CloseOrder(String appid, String mch_id, String out_trade_no, String key) {
    this.appid = appid;
    this.mch_id = mch_id;
    this.out_trade_no = out_trade_no;
   ...
   * @param key               微信商户平台(pay.weixin.qq.com)-->账户中心-->账户设置-->API安全-->密钥设置
   */
  public WxData_CloseOrder(String appid, String mch_id, String out_trade_no, String key, String sub_mch_id ) {
    this.appid = appid;
    this.mch_id = mch_id;
    this.out_trade_no = out_trade_no;
    this.nonce_str = WxPayUtils.getNonce_str();
