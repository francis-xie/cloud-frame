...
var PostList = {
    ...
    mounted: function () {
        axios.get('/vi/api/post').then(function (res) {
            if (res.data.error) {
        ...
        handleSubmit: function (e) {
            ...
            axios.post('/vi/api/authentication', {
                ...
                if (res.data.error) {
                    ...
                    //Cookies.set('currentUser', JSON.stringify(res.data.user),{ expires: 15});
                    emitLogin()
                    this.$router.push('/')
                }
            }.bind(this))
...
var PostDetail = {
    ...
    mounted: function () {
        axios.get('/vi/api/post/' + this.$route.params.id).then(function (res) {
            if (res.data.error) {
                handleError(res.data.error)
                return
            } else {
